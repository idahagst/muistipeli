...
public class Peli {
    ...
    /**
     * metodi aloittaa pelin, asettaa sille korkeuden ja leveyden, luo taulukon
     * joka koostuu korteista ja asettaa ekan ja tokan kortin kääntämättömiksi
    ...
    /**
     * metodi testaa onko kaksi korttia samat jos kaksi korttia on samat, metodi
     * poistaa ne pelistä, lisaa pelaajalle parin ja yrityksen ja asettaa
     * ensimmäisen ja toisen kortin kääntämättömäksi jos kaksi korttia ei ole
     * samat, metodi lisää pelaajalle yrityksen ja kääntää kortit takaisin
     * väärinpäin
     *
    ...
    /**
     * metodi kertoo onko kaikki pöydällä olevat kortit jo käännetty eli onko
     * kaikki korttiparit löydetty
     *
    ...
    /**
     * metodi poistaa kaikki kortit listalta, jolloin peliin ei voida valita
     * yhtään korttia
     */
